...
public class AccountController {
   ...
   public String add(Model model) {
	   ...
	   return "admin/accounts/addAccount";
   }
   ...
   public ModelAndView edit( ModelMap model, @PathVariable("username") String username) {
	   ...
	   if (opt.isPresent()) {
		...
		return new ModelAndView("admin/accounts/addAccount", model) ;
	}
   ...
   public ModelAndView delete( ModelMap model, @PathVariable("username") String username) {
	   ...
	   model.addAttribute("message", "Account id delete");
	   return new ModelAndView("redirect:/admin/accounts/list", model);
   }
   ...
   public ModelAndView saveOrUpdate(ModelMap model,@Valid @ModelAttribute("account") AccountDto dto, BindingResult result ) {
	   if (result.hasErrors()) {
		   ...
		   return new ModelAndView("admin/accounts/addAccount");
	}
   ...
   public String search(ModelMap model, 
	   ...
	   return "admin/accounts/seachpaginated";
   }
}
